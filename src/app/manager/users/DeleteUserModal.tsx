...
export default function DeleteUserModal({ open, onClose, user, onConfirm }: { open: boolean; onClose: () => void; user: any; onConfirm: () => void }) {
  return (
    <Modal isOpen={open} onClose={onClose} className="max-w-md w-full rounded-2xl">
      <div className="bg-white rounded-2xl p-8 text-center">
        ...
        <div className="flex justify-center gap-3 pt-2">
          ...
          <Button className="bg-error-500 text-white" onClick={onConfirm}>Delete</Button>
        </div>
      </div>
    </Modal>
  );
